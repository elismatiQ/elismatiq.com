...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org), version 3.0, available at [https://www.contributor-covenant.org/version/3/0/code_of_conduct.html](https://www.contributor-covenant.org/version/3/0/code_of_conduct.html).
...
5. Donner et accepter gracieusement des commentaires constructifs.
6. S'engager à réparer les torts lorsqu'ils surviennent.
7. Se comporter d'autres manières qui favorisent et soutiennent le bien-être de notre communauté.

## Comportements Restreints

Nous acceptons de restreindre les comportements suivants dans notre communauté. Les instances, menaces et promotions de ces comportements sont des violations de ce Code de Conduite.

1. **Harcèlement.** Violer les limites explicitement exprimées ou s'engager dans une attention personnelle inutile après toute demande claire d'arrêt.
2. **Attaques personnelles.** Faire des commentaires insultants, dégradants ou péjoratifs dirigés vers un membre de la communauté ou un groupe de personnes.
...
4. **Sexualisation.** Se comporter d'une manière qui serait généralement considérée comme inappropriée et intime dans le contexte ou le but de la communauté.
...
1. **Identité trompeuse.** Usurper l'identité de quelqu'un d'autre pour quelque raison que ce soit, ou prétendre être quelqu'un d'autre pour échapper aux mesures d'application.
2. **Défaut de créditer les sources.** Ne pas créditer correctement les sources du contenu que vous contribuez.
3. **Matériel promotionnel.** Partager du marketing ou tout autre contenu commercial d'une manière qui est en dehors des normes de la communauté.
...
## Traitement et Réparation des Préjudices
...
Ce Code de Conduite s'applique dans tous les espaces communautaires, et s'applique également lorsqu'un individu représente officiellement la communauté dans des espaces publics ou autres. Des exemples de représentation de notre communauté incluent l'utilisation d'une adresse e-mail officielle, la publication via un compte de réseau social officiel ou l'action en tant que représentant nommé lors d'un événement en ligne ou hors ligne.

## Attribution

Ce Code de Conduite est adapté du [Contributor Covenant](https://www.contributor-covenant.org), version 3.0, disponible sur [https://www.contributor-covenant.org/version/3/0/code_of_conduct.html](https://www.contributor-covenant.org/version/3/0/code_of_conduct.html).

Le Contributor Covenant est géré par l'[Organization for Ethical Source](https://ethicalsource.dev) et sous licence [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
